...
import {
  ...
  BackButton,
  Notification,
} from '../frontend/styles/addGames.styles';
...
const AddGameForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setNotification({ type: 'success', message: 'Juego agregado exitosamente.' });
      setTimeout(() => router.push('/games'), 2000); // Redirigir después de 2 segundos
    } catch (error) {
      console.error('Error al agregar el juego:', error);
      setNotification({ type: 'error', message: 'Error al agregar el juego. Intenta nuevamente.' });
    }
  };
  ...
  return (
    <FormContainer>
      <FormLeft>
        <FormTitle>Agregar Nuevo Videojuego</FormTitle>
      ...
      <FormRight>
        ...
        <ButtonContainer>
          <SubmitButton type="submit" form="gameForm">
